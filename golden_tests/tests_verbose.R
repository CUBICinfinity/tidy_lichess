...
c('7B/8/5k2/8/8/8/8/8 b - - 0 1', 'Kg7', '7B/5k2/8/8/8/8/8/8 w - - 1 2'), # illegal position. move out of check. should not raise warning
c('8/8/8/8/1Q1qk1K1/8/8/8 b - - 1 2', 'Qg1+', '8/8/8/8/1Q2k1K1/8/8/6q1 w - - 2 3'), # pinned # !!error permitted
