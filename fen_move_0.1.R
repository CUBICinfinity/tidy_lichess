      ...
      if (! is.na(file) && ! is.na(rank)) {
        ...
        if (piece %in% c("p","P")) {
          ...
          if (position_2d[[source_rank]][source_file] != piece) {
            ...
            # Add en passant flag
            en_passant_target <- paste0(target_file, target_rank)
          }
        }
          ...
          if (target_file == source_file) {
            ...
            if (source_rank == "" && target_rank - distance > 0) {
        ...
        if (piece %in% c("p","P")) {
          ...
          if (target_rank == source_rank) {
            ...
            if (source_file == "" && target_file - distance > 0) {
        ...
        if (piece %in% c("p","P")) {
          ...
          if (source_file == "") { # still not found
            # look up
            for (r in (target_rank:1)[-1]) {
              if (position_2d[[r]][target_file] == piece) {
                source_rank <- r
